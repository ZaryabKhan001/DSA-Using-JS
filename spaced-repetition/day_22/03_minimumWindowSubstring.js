...
//? Time Complexity: O(m + n * k) where n is the length of s and k is the unique characters in t.
//? Space Complexity: O(n + k) where n is the result string and k is the unique characters in t and s.
...
//? Time Complexity: O(m + n) where n is the length of s and m is the length of t.
//? Space Complexity: O(n + k) where n is the result string and k is the unique characters in t and s.
